package com.minatogithuborganization.testignow;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborganization.testignow"})
@EnableCaching
...
public class TestignowApplication {

	public static void main(String[] args) {
		SpringApplication.run(TestignowApplication.class, args);
	}
