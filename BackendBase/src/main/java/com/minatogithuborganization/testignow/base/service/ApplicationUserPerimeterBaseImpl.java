package com.minatogithuborganization.testignow.base.service;
...
import com.minatogithuborganization.testignow.model.Roles;
...
import com.minatogithuborganization.testignow.base.model.ApplicationUserBase;
import com.minatogithuborganization.testignow.base.model.constants.ApplicationUserConstantBase;
...
public abstract class ApplicationUserPerimeterBaseImpl<T extends ApplicationUserBase> implements IPerimeterManager<T>, ApplicationUserConstantBase {
	...
	protected List<String> getTechnicalFields() {
		String[] technicalFields = {"sid", "createdBy", "createdDate", "modifiedBy", "modifiedDate", "recDeleted", "isLogin", "emailInLowerCase", "userPreference", "devAdmin", "userRoles", "email", "firstName", "lastName"};
